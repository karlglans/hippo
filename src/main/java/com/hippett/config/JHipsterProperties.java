...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hippo@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hippo API";

        private String description = "hippo API documentation";
